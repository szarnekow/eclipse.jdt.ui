...
public class TypeSetEnvironment {
	...
	private final Map/*<TType, SubTypesOfSingleton>*/<TType, SubTypesOfSingleton> fSubtypesOfSingletons= new LinkedHashMap<TType, SubTypesOfSingleton>();//@perf
	private final Map/*<TType, SubTypesSet>*/<TypeSet, SubTypesSet> fSubTypesSets= new LinkedHashMap<TypeSet, SubTypesSet>();//@perf
	private final Map/*<TType, SuperTypesOfSingleton>*/<TType, SuperTypesOfSingleton> fSuperTypesOfSingletons= new LinkedHashMap<TType, SuperTypesOfSingleton>();//@perf
	private final Map/*<TType, SuperTypesSet>*/<Object, SuperTypesSet> fSuperTypesSets= new LinkedHashMap<Object, SuperTypesSet>();//@perf
